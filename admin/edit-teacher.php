        ...
        if( $_SERVER["REQUEST_METHOD"] == "POST" ){
            ...
            if( !empty($name) && !empty($email) && !empty($pass) && !empty($salary) ){
                ...
                if( mysqli_num_rows($r) > 0 ){
                    ...
                    $sql = "UPDATE teacher SET name = '$name' , email = '$email', password ='$pass' , dob='$dob', gender='$gender' , salary='$salary' WHERE id = $_GET[id] ";
                    $result = mysqli_query($conn , $sql);
                    if($result){
                        echo "<script>
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-4 shadow">                       
                                    <h4 class="text-center">Edit teacher profile</h4>
