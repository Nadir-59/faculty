        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3"> Students Management System </h2>
                 </div>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                   <br> <br>     
                   <h4>teacher <?php echo $_SESSION["teacher_name"]; ?></h4>  
                    <li>
                    ...
                    <li>
                        <a href="./attendance.php?teacher_name=<?php echo $_SESSION['teacher_name']; ?>" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">attendance</span>
                        </a>
                    </li>
