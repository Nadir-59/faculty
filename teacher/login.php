...
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
  ...
  if( !empty($email) && !empty($pass) ){
    ...
    $sql_query = "SELECT * FROM teacher WHERE email='$email' && password = '$pass'  ";
    ...
    if ( mysqli_num_rows($result) > 0 ){
     while( $rows = mysqli_fetch_assoc($result) ){
      ...
      $_SESSION["teacher_name"] = $rows["name"];
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                    ...
                                    <h4 class="text-center">Hello, teacher</h4>
                                ...
                                <p class=" login-form__footer">Not a teacher? <a href="../admin/login.php" class="text-primary">Log-In </a>as Admin now</p>
                                </form>
                            </div>
                        </div>
                    </div>
